...
namespace Broccoli.BroccoEditor {
    ...
    public class MainSproutLabEditorImpl : ISproutLabEditorImpl
    {
        ...
        private static GUIContent EMPTY_BRANCH_BTN = new GUIContent ("Empty Branch Collection", "Create a Project with the minimum number of elements to expand it from there.");
        ...
        public void DrawSelectModeViewAfterOptions () {
            ...
            if (GUILayout.Button (EMPTY_BRANCH_BTN)) {
                OnCreateBranchDescrptorCollection (IMPL_BRANCH);
                sproutLabEditor.SetView (SproutLabEditor.ViewMode.Structure);
			}
